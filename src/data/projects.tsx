...
const projects: Project[] = [
  ...
  { // 01. AI Docker file optimizer project
    ...
    github:"https://github.com/AsutoshRout/AI-Docker-file-optimizer",
    skills: {
  ...
  { // 02. FinanceMe project
    ...
    live: "https://github.com/AsutoshRout/FinanceMe-Devops-Project-01",
    github: "https://github.com/AsutoshRout/FinanceMe-Devops-Project-01",
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
  ...
  { // 03. Portfolio project
    ...
    live: "https://www.asutoshrout.com/",
    github:"https://github.com/AsutoshRout/3D-interactive-portfolio",
    skills: {
      frontend: [
        PROJECT_SKILLS.ts,
        PROJECT_SKILLS.next,
  ...
  { // 04. Smart parking assitant
    ...
    live: "https://github.com/AsutoshRout/smart-parking-assistant",
    github:"https://github.com/AsutoshRout/smart-parking-assistant",
    skills: {
  ...
  { // 05. Smart Job Tracker project
    ...
    github:"https://github.com/AsutoshRout/Job-tracker-application",
    skills: {
      frontend: [PROJECT_SKILLS.js, PROJECT_SKILLS.next, PROJECT_SKILLS.tailwind, PROJECT_SKILLS.vite],
  ...
  { // 06. Savinder Puri portfolio project
    ...
    github:"https://github.com/AsutoshRout/savinder-puri",
    skills: {
      frontend: [PROJECT_SKILLS.js, PROJECT_SKILLS.next, PROJECT_SKILLS.tailwind, PROJECT_SKILLS.vite],
      backend: [],
    },
      ...
      return (
        <div>
          <TypographyP className="font-mono ">
            ...
            transforms lives. 💻🕊️ Crafted with ❤️ by Asutosh Rout! 🚀
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <SlideShow
            images={[
