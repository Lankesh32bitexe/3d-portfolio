...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "asutoshrout@gmail",
    href: "mailto:asutoshrout@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/asutosh-rout/",
    content: "/asutosh-rout",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/AsutoshRout",
    content: "/asutosh-rout",
            ...
            <div className="flex flex-row lg:flex-col items-center">
              <div className="flex justify-center items-center lg:w-full lg:aspect-square bg-zinc-800 rounded-xl lg:mb-5">
                <img
                  ...
                  alt="me"
                  src="/assets/asutosh.png"
                />
              </div>
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Asutosh Rout</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Asutosh, a Comp. Sci. Engineer with expertise in Development, DevOps and 
              Database management. I have hands-on experience in deploying & automating workflows, and 
              collaborating on various scale projects. Strong analytical skills, effective communication,
